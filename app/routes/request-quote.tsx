...
// Temporarily commented out while waiting for SES production access
// import {
...
export async function action({ request }: Route.ActionArgs) {
  ...
  if (intent === "submit-quote") {
    ...
    try {
      ...
      return {
        success:
          "Quote request submitted successfully! We have received your request and will get back to you within 24 hours.",
      };
    } catch (error) {
              ...
              <div className="space-y-4">
                {cartItems.map((item, index) => (
                  <motion.div
                    ...
                    className="flex items-center space-x-4 p-4 border border-gray-200 rounded-xl hover:shadow-sm transition-shadow"
                  >
                    {/* Product Image */}
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-50 text-sm font-semibold"
                      >
                        −
                      </button>
